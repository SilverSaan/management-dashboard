...
interface IconProps {
    ...
    fontSize?: "medium" | "inherit" | "large" | "small" | undefined
  }

export function BatIcon({color, fontSize}: IconProps) {
  return (
    <SvgIcon fontSize={fontSize || "medium"}>
    <svg
        width={800}
        height={800}
        viewBox="0 0 512 512" 
      ...
      >
        ...
        <g>
            ...
            d="M475.504,199.888c-31.897-63.168-72.205-95.894-84.65-106.11c-17.172-14.109-31.107-12.578-30.201,1.688
